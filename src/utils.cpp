...
void print_usage(const std::string& program_name) {
    ...
    std::cout << "  -o, --output VIDEO       Output video file\n";
    std::cout << "  -b, --bbox X,Y,W,H       Initial bounding box\n";
    std::cout << "  -t, --template MODEL     Template ONNX model path\n";
    std::cout << "  -s, --search MODEL       Search ONNX model path\n";
    std::cout << "  --benchmark              Enable performance monitoring\n";
    std::cout << "  --display                Show real-time visualization\n";
    std::cout << "  --save-frames            Save individual frames\n";
    std::cout << "  --fps-limit N            Limit processing to N FPS\n";
    std::cout << "  --threads N              Number of ONNX inference threads\n";
    std::cout << "  -h, --help               Show this help message\n";
    std::cout << "\nExample:\n";
    std::cout << "  " << program_name << " -i video.mp4 -o output.mp4 -b 100,50,80,120 --benchmark\n";
}
